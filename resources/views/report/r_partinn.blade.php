        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form id="form-add" method="post" role="form" id="form-print" action="summary_partin" enctype="multipart/form-data" formtarget="_blank" target="_blank">
                                @csrf
                                    ...
                                    <div class="col-md-12">
                                        <div class="control-group">
                                            <div class="controls pt-2">
                                                <input onclick="reset_form()" id="subpr" class="btn btn-secondary btn-block" type="button" value="Rekap Part In">
                                            </div>
                                        </div>
                                    </div>
                                </div>
