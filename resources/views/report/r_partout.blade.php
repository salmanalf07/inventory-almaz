        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            @if(request()->is('r_partout'))
                            <form id="form-add" method="post" role="form" id="form-print" action="report_partout" enctype="multipart/form-data" formtarget="_blank" target="_blank">
                                @else
                                <form id="form-add" method="post" role="form" id="form-print" action="report_sumpart" enctype="multipart/form-data" formtarget="_blank" target="_blank">
                                    @endif
                                    @csrf
