...
<script>
    ...
    $(document).on('click', '#edit', function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                AutoNumeric.getAutoNumericElement('#price').set(data.price);
                $('#sa_dm').val(data.sa_dm);
                $('#qty_pack').val(data.qty_pack);
                $('#type_pack').val(data.type_pack);
    ...
    //update price mass
    $(document).on('click', '#mass-price', function(e) {
