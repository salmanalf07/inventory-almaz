    ...
    $(document).ready(function() {
        ...
        $.fn.dataTable.ext.buttons.add = {
            ...
            action: function(e, dt, node, config) {
                ...
                reset_form();
                var date = new Date();
                $("#plan_delivery").val((date.getDate() + 1) + "/" + ("0" + (date.getMonth() + 1))
        ...
        var oTable = $('#example1').DataTable({
            ...
            columns: [{
                ...
                },
                {
                    ...
                    name: 'part_in.date_in'
                },
                {
                    data: 'part_in.no_sj_cust',
                    name: 'part_in.no_sj_cust'
                },
                {
                ...
                {
                    data: 'part_in.created_at',
                    name: 'part_in.created_at'
                },
                {
                    data: 'aksi',
                    name: 'aksi'
