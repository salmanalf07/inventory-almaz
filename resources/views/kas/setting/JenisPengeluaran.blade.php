                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="control-group">
                                    <label class="control-label">Type Pengeluaran</label>
                                    <div class="controls">
...
<script>
    ...
    $('.modal-footer').on('click', '.add', function() {
        ...
        $.ajax({
            type: 'POST',
            url: '{{ url("store_jenisPengeluaran") }}',
            data: fd,
            processData: false,
            contentType: false,
    ...
    $('.modal-footer').on('click', '.update', function() {
        ...
        $.ajax({
            type: 'POST',
            url: 'update_jenisPengeluaran/' + id,
            data: fd,
            processData: false,
            contentType: false,
            success: function(data) {
    ...
    $(document).on('click', '#delete', function(e) {
        ...
        if (confirm('Yakin akan menghapus data ini?')) {
            ...
            $.ajax({
                type: 'DELETE',
                url: 'delete_jenisPengeluaran/' + $(this).data('id'),
                data: {
                    '_token': "{{ csrf_token() }}",
                },
                success: function(data) {
